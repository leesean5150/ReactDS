...
import { TeamExample } from "./team.tsx";
import { ProjectsExample } from "./projects.tsx";
import { CalendarExample } from "./calendar.tsx";
...
const DashboardExample = () => {
  return (
    <Routes>
        ...
        element={
          <div>
            ...
            <div className="BodyContainer">
              <p>
                This is where the Dashboard body component should be rendered
              </p>
              <br />
              <p>
      ...
      />
      <Route path="team" element={<TeamExample />} />
      <Route path="projects" element={<ProjectsExample />} />
